...
from wtforms import StringField, SelectField, DecimalField, TextAreaField, IntegerField, RadioField, HiddenField, SubmitField, DateField, BooleanField, MultipleFileField
...
class FormularioVendaWizard(FlaskForm):
    ...
    prioridade = BooleanField('Alta Prioridade (Urgente)')
    ...
    # CAMPO NOVO ADICIONADO AQUI:
    fotos_pecas = MultipleFileField('Fotos das Peças (Máx 3)', validators=[Optional()])
